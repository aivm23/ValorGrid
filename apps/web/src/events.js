import { setupInstrumentForm } from './instrument-create-market-data.js';
import {
  createGroup,
  createInstrument,
  handleInstrumentGroupsToggle,
  saveGroup,
  saveInstrument,
...
export function attach(ctx) {
  ...
  async function handleDeleteBackup(backupFile) {
    const label = ctx.t('backups.delete');
    const message = ctx.t('backups.confirmDelete', { file: backupFile });
