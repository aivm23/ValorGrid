...
function bindGroupedCtxNamespaces(ctx) {
  ...
  Object.assign(ctx.services.uiPreferences, pickCtxFunctions(ctx, ['getUiPreferences', 'saveUiPreferences']));
  Object.assign(ctx.services.http, pickCtxFunctions(ctx, ['monthLabel', 'resolveRequestPath', 'handleApi', 'server']));
  Object.assign(ctx.services.marketData, pickCtxFunctions(ctx, ['handleAlphaVantageKeyRoutes']));
  Object.assign(
