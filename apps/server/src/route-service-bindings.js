...
function resolveRouteHandlers(ctx) {
  ...
  const corporateActionServices = ctx.services?.corporateActions || {};
  ...
  return {
    ...
    previewInstrumentDelete: pickServiceFn(instrumentServices, 'previewInstrumentDelete', ctx.previewInstrumentDelete),
    ...
    setInstrumentGroupsEnabled: pickServiceFn(
      instrumentServices,
      'setInstrumentGroupsEnabled',
      ctx.setInstrumentGroupsEnabled,
    ),
    buildOnboardingStatus: pickServiceFn(onboardingServices, 'buildOnboardingStatus', ctx.buildOnboardingStatus),
    previewOnboardingWizard: pickServiceFn(onboardingServices, 'previewOnboardingWizard', ctx.previewOnboardingWizard),
    ...
    scanCorporateActions: pickServiceFn(corporateActionServices, 'scanCorporateActions', ctx.scanCorporateActions),
    listCorporateActions: pickServiceFn(corporateActionServices, 'listCorporateActions', ctx.listCorporateActions),
    ...
    searchTickerSuggestions: pickServiceFn(suggestionServices, 'searchTickerSuggestions', ctx.searchTickerSuggestions),
