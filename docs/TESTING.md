...
| `test/imports.test.js`             | 410+   | 21    | Importación  | ValorGrid Community: plantilla XLSX oficial, preview, commit, rollback, divisas, FX manual, auto-cómputo, edge cases, selección de hoja, rechazo de fuentes legacy, descarga de plantilla con headers HTTP, sample S&P500 sintético. |     |
