...
| `test/portfolio.test.js`           | 634    | 34    | Core CRUD    | Transacciones, instrumentos, grupos, identifiers, auto-plans, backups, health, onboarding, state, quote, export XLSX, endpoints legacy 404 y limpieza de export CSV/JSON.                      |
