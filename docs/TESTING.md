...
| `test/portfolio.test.js`           | Core CRUD     | Transacciones, instrumentos, grupos, identifiers, fuentes/precios de mercado, auto-plans, backups, health, onboarding, state, quote, export XLSX, endpoints legacy 404 y limpieza de export CSV/JSON.     |
