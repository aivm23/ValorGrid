...
| `test/imports.test.js`             | 577    | 34    | Importacion  | Plantilla XLSX Community con parser ExcelJS, preview, commit, rollback, controles de seguridad, rechazo de fuentes legacy, headers de descarga y sample sintetico S&P 500.                     |
...
| `test/privacy.test.js`             | 198    | 8     | Privacidad   | Artefactos SQLite ignorados, paths locales, etiquetas personales, fresh install limpio, `.gitignore`, `.dockerignore` y XLSX publicos sin tokens privados.                                     |
