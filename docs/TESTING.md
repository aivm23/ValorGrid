...
| `test/imports.test.js`             | 900+   | 38    | Importación  | Plantilla ValorGrid XLSX: preview, commit, rollback, divisas, FX manual. DEGIRO: Transactions.csv, snapshot, ventas, ticker suggestions. IBKR: normalización. Rechazo de fuentes legacy. Descarga de plantilla. |
