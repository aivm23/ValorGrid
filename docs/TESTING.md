...
| `test/imports.test.js`             | 250+   | 10    | Importación  | ValorGrid Community: plantilla XLSX oficial, preview, commit, rollback, divisas, FX manual, seleccion de hoja, rechazo de fuentes legacy y descarga de plantilla.                                    |
