...
test('DEGIRO Transactions.csv format maps signed quantity, fees and subtype correctly', () => {
  ...
  const content = [
    'Fecha,Hora,Producto,ISIN,Bolsa de referencia,Centro de ejecuci�n,N�mero,Precio,,Valor local,,Valor EUR,Tipo de cambio,Comisi�n AutoFX,Costes de transacci�n y/o externos EUR,Total EUR,ID Orden,',
